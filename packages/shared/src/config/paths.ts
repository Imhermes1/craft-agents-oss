...
// Falls back to custom directory to avoid conflicts with stock Craft Agents
export const CONFIG_DIR = process.env.CRAFT_CONFIG_DIR || join(homedir(), '.craft-agent-custom');
