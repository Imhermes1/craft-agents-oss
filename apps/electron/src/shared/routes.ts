...
export const routes = {
  ...
  action: {
     ...
     */
    newChat: (params?: { input?: string; name?: string; send?: boolean; runtime?: string; model?: string; sources?: string; mode?: string; workdir?: string }) =>
